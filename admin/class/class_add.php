      ...
      <main class="main_container content_pd">
        <div class="tt_wrapper d-flex justify-content-between align-items-center">
          <div class="d-flex justify-content-between align-items-center gap-3">
            <h2 class="main_tt pre_bold_l">강좌 등록</h2>
          </div>
          <img src="/ksv_lms/admin/img/img_logo.png" alt="logo">
        </div>
        <form action="class_add_ok.php" onsubmit="return save();" method="post" enctype="multipart/form-data">
            ...
            <div class="cls_title">
                <input type="text" id="cls_title" name="cls_title" class="pre_rg_s" required placeholder="강좌명을 입력하세요.">
            </div>
            <div class="about_price d-flex justify-content-between gap-3">
                ...
                <div class="cls_price col">
                    ...
                    <input type="text" id="cls_price" name="cls_price" class="pre_rg_s col" required placeholder=" 원">
                </div>
            </div>
            <h3 class="pre_bold_m">강좌옵션</h3>
            <div class="lecture_option pre_rg_s d-flex justify-content-between align-items-center gap-3">
                <input type="checkbox" name="cls_recom" id="cls_recom" value="1">
                <label for="cls_recom" class="col">추천</label>
                <input type="checkbox" name="cls_basic" id="cls_basic" value="1">
                <label for="cls_basic" class="col">초급</label>
                <input type="checkbox" name="cls_inter" id="cls_inter" value="1">
                <label for="cls_inter" class="col">중급</label>
                <input type="checkbox" name="cls_adv" id="cls_adv" value="1">
                <label for="cls_adv" class="col">고급</label>
            </div>
            <div class="cls_text">
                <h3 class="pre_bold_m">강좌설명</h3>
                <label for="cls_text" class="hidden"></label>
                <textarea id="cls_text" name="cls_text" class="pre_rg_s" cols="30" rows="10" required placeholder="강좌설명을 입력하세요."></textarea>
            </div>
            <div class="cls_thumb">
                ...
                <div class="d-flex justify-content-between gap-3">
                  ...
                  <input class="file_name" id="cls_thumb" name="cls_thumb" value="파일을 첨부해주세요." >
                </div>
            </div>
            <div class="btns d-flex justify-content-end gap-3">
              <button type="submit" class="btn_m_pc pre_rg_m">강좌 등록</button>
